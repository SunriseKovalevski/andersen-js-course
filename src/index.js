...
import { task5Old, task5New, task5New1 } from './es-features/task5';
...
console.log('task5 new 1', task5New1(['test', 42], { name: 'foo', val: 7 })); // ['test', 42, 'foo', 7]
...
console.log('task9 new 1', task9New1()); // [true, 1]
...
console.log('arrayDiff', arrayDiff([1, 3, 3, 4], [1, 3, '4']));
